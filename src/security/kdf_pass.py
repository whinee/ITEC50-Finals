...
def get_kdf() -> Argon2id:
    """
    Instantiates a brutally secure Argon2id Key Derivation Function (KDF).
    ...
    Returns: Argon2id: A fully configured, cryptographic-grade hasher ready for derivation.
    """
    return Argon2id(
        salt=os.urandom(16),
        length=32,
