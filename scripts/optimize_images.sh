...
ICON_PDF_REL_SRC_PATH="dark-favicon-not-safe.svg"
ICON_REL_PDF_OUT_PATH="logo.pdf"
...
ICON_PDF_SRC_PATH="$SRC_DIR/$ICON_PDF_REL_SRC_PATH"
ICON_PDF_OUT_PATH="$PAPER_DIR/$ICON_REL_PDF_OUT_PATH"
...
cairosvg "$ICON_PDF_SRC_PATH" -o "$ICON_PDF_OUT_PATH"
# inkscape "$ICON_PDF_SRC_PATH" --export-area-drawing --export-filename="$ICON_PDF_OUT_PATH"
